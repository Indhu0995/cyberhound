...
?>
<a href='http://vkmbs.com/hound'>Click Here</a> to login.
<?php
}else{
...
<html>
<body>
<p>Hello User!<br>You <a href='http://vkmbs.com/hound/forgot-password.php?m=".$email."&t=".$timestamp."'>
click here</a> to reset your password or open the following link in a new window.<br>
http://vkmbs.com/hound/forgot-password.php?m=".$email."&t=".$timestamp."<br>
