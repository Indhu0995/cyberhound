...
$gete = mysql_fetch_array(mysql_query("SELECT * FROM device WHERE id='".$_GET['edit']."'"));
  ...
  <form action='' method='post' class='row col-md-12'>
    ...
    <input type='text' class='form-control col-md-6' name='dynamic_nature' placeholder='Dynamed Nature' value='<?php echo $gete[17];?>'><br>
...
?><input type='submit' class='btn btn-primary col-md-6' name='add_new' value='Add New'><?php } ?>
  ...
  $storecap = $_POST['storecap'];
  $connect_type = $_POST['connect_type'];
  $data_security  = $_POST['data_security'];
  $comm_range = $_POST['comm_range'];
  $dynamic_nature = $_POST['dynamic_nature'];
  $protocol_used  = $_POST['protocol_used'];
